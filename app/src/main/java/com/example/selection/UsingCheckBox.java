...
public class UsingCheckBox extends BaseActivity {
    Button btnSave, btnCancel;
    EditText txtBudget;
    CheckBox chkHousing, chkTransportation, chkGroceries, chkUtilities;
    CheckBox chkInvestment, chkDebtpy, chkRetirement, chkEmergencyF;
    CheckBox chkDining, chkSocial, chkClothing, chkTravel;
    ...
    protected int getLayoutResId() {
        return R.layout.activity_using_check_box;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkDebtpy = findViewById(R.id.chkDeptpy);
        chkRetirement = findViewById(R.id.chkRetirement);
        chkEmergencyF = findViewById(R.id.chkEmergencyF);
        arrFinancial = new CheckBox[] { chkInvestment, chkDebtpy, chkRetirement, chkEmergencyF };

        chkDining = findViewById(R.id.chkDining);
        chkSocial = findViewById(R.id.chkSocial);
        chkClothing = findViewById(R.id.chkClothing);
        chkTravel = findViewById(R.id.chkTravel);
        arrVoluntary = new CheckBox[] { chkDining, chkSocial, chkClothing, chkTravel };

        btnSave = findViewById(R.id.btnSave);
        btnSave.setOnClickListener(v -> computeBudget());
        btnCancel = findViewById(R.id.btnCancel);
        btnCancel.setOnClickListener(v -> clearChecks());
